...
import "./Home.css";
import sample from "../../img/video_Trim.mp4";
...
export default function Home() {
  ...
  return (
    <>
      <div className=" position-absolute behind">
        <video className="video-fluid" autoPlay loop muted>
          <source src={sample} type="video/mp4" />
        </video>
      </div>
      <div className="container-fluid position-relative  overflow-hidden">
        <div className="row  bgcolor overflow-hidden">
          <div className="col-sm-5 set-up align-items-center">
          ...
          <div class="timeline">
            ...
            <div class="timeline-component timeline-content">
              ...
              <p className="h6">
                ...
                will- work with the client to agree on the social. media goals
            ...
            <div class=" timeline-component timeline-content">
              ...
              <p className="h6">
                If the client doesn't have social media accounts, we will set
                them up, ensuring consistency in branding, messaging, and
                aesthetics across all platforms.
              </p>
            </div>
            <div class="timeline-component timeline-content">
              ...
              <p className="h6">
                ...
                accounts. This content will be aligned with the client's
            ...
            <div class=" timeline-component timeline-content">
              ...
              <p className="h6">
                We will manage social media advertising campaigns for the
                client. This will involve identifying the target audience,
                creating ad copy and visuals, and monitoring the campaigns to
                ensure they are delivering results.
              </p>
            </div>
            <div class="timeline-component timeline-content">
              ...
              <p className="h6">
                ...
                areas of improvement and make necessary adjustments to the
                social media strategy. This will result in providing regular
                reports to the client, outlining the social media performance,
